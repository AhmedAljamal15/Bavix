...
class _DeliveryNoteDetailsScreenState extends State<DeliveryNoteDetailsScreen> {
  dynamic note;
  bool isLoading = true;
  String? errorMessage;
...
class _DeliveryNoteHeroCard extends StatelessWidget {
  final String noteId;
    ...
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        return Wrap(
          ...
          runSpacing: spacing,
          children:
              children.map((child) => SizedBox(width: width, child: child)).toList(),
        );
      },
    );
  }
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          Row(
            children: [
              Expanded(child: _SmallMetric(label: 'Qty', value: qty)),
              Expanded(child: _SmallMetric(label: 'Rate', value: rate)),
              Expanded(
                child: _SmallMetric(
                  label: 'Amount',
                  value: amount,
